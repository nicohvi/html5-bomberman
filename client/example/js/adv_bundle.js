...
client.connect(function (controller) {
  ...
  psCtrl.connect(function (psSocket) {
    psSocket.on('left', function (data) {
      return controller.move('left');
    });
    psSocket.on('right', function (data) {
      return controller.move('right');
    });
    psSocket.on('up', function (data) {
      return controller.move('up');
    });
    psSocket.on('down', function (data) {
      return controller.move('down');
    });
    psSocket.on('bomb', function (data) {
      return controller.bomb();
    });
    psSocket.on('powerup', function (data) {
      return controller.powerUp();
    });
  });
...
},{"../../index":2,"../../playstation":4}],2:[function(require,module,exports){
"use strict";
